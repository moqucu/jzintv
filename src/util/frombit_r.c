...
/*  FROMBIT_R                                                   J. Zbiciak  */
/*                                                                          */
/*  Reads a file (or a pipe) containing a bit-dump, producing a binary      */
/*  file.  The bit-dump file should be in the following format:             */
/*                                                                          */
/*     1011 101 00110 ...  [# optional comment]                             */
/*                                                                          */
/*  eg. A list of bits optionally followed by a comment.  Comments start    */
/*  with a # and end at the next newline.  Lines may be arbitrarily long.   */
/*                                                                          */
/*  Usage:  frombit_r [infile [outfile]]                                    */
/*                                                                          */
...
/*                                                                          */
/*  NOTE:  In this version, bits are packed into bytes in the opposite      */
/*  order than you'd probably expect.  The first bit goes to bit 0 of the   */
/*  first byte, the next to bit 1, etc.                                     */
/* ======================================================================== */
