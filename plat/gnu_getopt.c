...
#if 1 /* DISABLE THIS MAGIC TO WORK WITH MINGW32 */
#include <string.h>
...
/* ======================================================================== */
/*  The following variable definition is present to keep certain over-anal  */
/*  compilers from complaining that the translation unit contained no       */
/*  actual definitions.                                                     */
/* ======================================================================== */
